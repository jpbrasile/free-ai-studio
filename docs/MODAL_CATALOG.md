...
- Le Studio **ne lit pas** le crédit restant ni la facture chez Modal. Le plafond partagé (`MODAL_BUDGET_USD_PAR_MOIS`, unique pour la vidéo, la chanson, le dialogue et le Sandbox depuis le 19/09/2026) est une estimation locale, et le crédit affiché (`MODAL_CREDIT_MENSUEL_USD`) est une **déclaration** de l'utilisateur.
